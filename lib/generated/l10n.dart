...
class S {
  ...
  String signUpTitle(String nameOfTheApp, DateTime when) {
    final DateFormat whenDateFormat =
        DateFormat('y MMMM d 🪴', Intl.getCurrentLocale());
  ...
  /// `{value} {value2, plural, =0{no comments} =1{comment} other{comments}}`
  String commentTitle(int value, num value2) {
    ...
    return Intl.message(
      '$valueString ${Intl.plural(value2, zero: 'no comments', one: 'comment', other: 'comments')}',
      name: 'commentTitle',
      desc: 'Anything you want',
